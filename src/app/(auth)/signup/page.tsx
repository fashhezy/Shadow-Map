  ...
  return (
    <div className="glass-panel p-8 rounded-xl w-full relative">
      ...
      <div className="text-center mb-8 mt-6">
        <h1 className="text-3xl font-heading font-semibold text-foreground mb-2">Create Account</h1>
        <p className="text-sm font-sans text-muted-foreground">Join Shadow Map to get started.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className="bg-black/20 border-white/10 focus-visible:ring-primary focus-visible:border-primary transition-all font-sans"
          />
          <p className="text-xs font-sans text-muted-foreground/60 mt-1">Minimum 6 characters</p>
        </div>
